...
urlpatterns = [
    ...
    path('antalumnos/formularioAltaAlbumFotos/', views.formularioAltaAlbumFotos, name='formularioAltaAlbumFotos'),
    ...
    path('antalumnos/exitoAltaAlbumFotos/<nombre>/', views.exitoAltaAlbumFotos, name='exitoAltaAlbumFotos'),
